import { TGenAttribute, TGenNode } from "./tgen-types";

const brackets=/\[\s*\]/g

export const parseNodeLine=(line:string,typeStartIndex:number,hasParent:boolean):TGenNode[]=>{
    ...
    const attributes:{[name:string]:TGenAttribute}={};
