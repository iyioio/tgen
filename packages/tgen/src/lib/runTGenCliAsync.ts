...
import { getDefaultTGenPlugins } from "./getDefaultTGenPlugins";
import { lucidCsvParser } from "./lucidCsvParser";
import { tgenCliFlags } from "./tgen-cli-const";
import { TGenCallback, TGenPipeline } from "./tgen-types";
import { zodGenerator } from "./zodGenerator";

export const runTGenCliAsync=async (argList:string[],argStart=0):Promise<TGenPipeline>=>{
    ...
    const addToList=(flag:keyof typeof tgenCliFlags,ary:TGenCallback[])=>{
